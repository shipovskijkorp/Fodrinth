...
const WINDOW_LABEL: &str = "curseforge-authors-downloads-v4";
const DASHBOARD_URL: &str = "https://authors.curseforge.com/dashboard";
const CAPTURE_SCRIPT: &str = include_str!("curseforge_capture.js");
const DOWNLOAD_SCRAPER: &str = include_str!("curseforge_downloads_v4.js");
const READY_PARAM: &str = "__fodrinth_cf_v4_ready";
const RESULT_PARAM: &str = "__fodrinth_cf_v4_result";
...
async fn ensure_window<R: Runtime>(app: &AppHandle<R>) -> Result<WebviewWindow<R>, String> {
    ...
    WebviewWindowBuilder::new(app, WINDOW_LABEL, WebviewUrl::External(url))
        .title("CurseForge Authors Analytics")
        ...
        .build()
        .map_err(|error| format!("Could not create CurseForge Authors analytics session: {error}"))
}
            ...
            r#"(() => {{
                ...
                const publish = () => {{
                    try {{
                        ...
                        const value = window.__FODRINTH_CF_DOWNLOAD_V4_RESULT__;
